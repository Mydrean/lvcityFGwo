...
<div class="container"> 		
   	...
   	<c:if test="${!empty scenictype }">
        ...
        <li><h3><a target="fengjing" href="<%=basePath%>/tourism/showlist.do?stid=${scenictype.stid}&pageNow=1">${scenictype.st}</a></h3></li>
        </c:forEach>
			</c:if>
	...
	<iframe id="fengjing" name="fengjing" src="<%=basePath%>/tourism/showlist.do?stid=${firstscenictypeid}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>
