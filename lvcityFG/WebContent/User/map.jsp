...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(107.402091,22.389258);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"我的位置",content:"广西民族师范学院<br/>数学与计算机科学学院<br/>D-e-m-o-n小组",point:"107.399881|22.39006",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
